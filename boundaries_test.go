...
func TestCarbon_StartOfDay(t *testing.T) {
	c1 := Create(2019, time.May, 22, 1, 1, 1, 1, getLocation("UTC"))
	c2 := c1.StartOfDay()
...
func TestCarbon_EndOfMonth(t *testing.T) {
	...
	c1 = Create(2019, time.April, 22, 1, 1, 1, 1, getLocation("UTC"))
	c2 = c1.EndOfMonth()
	...
	c1 = Create(2019, time.July, 22, 1, 1, 1, 1, getLocation("UTC"))
	c2 = c1.EndOfMonth()
	assert.EqualValues(t, 31, c2.Day())
	assert.EqualValues(t, 23, c2.Hour())
	assert.EqualValues(t, 59, c2.Minute())
	...
	c1 = Create(2019, time.August, 22, 1, 1, 1, 1, getLocation("UTC"))
	c2 = c1.EndOfMonth()
	assert.EqualValues(t, 31, c2.Day())
	assert.EqualValues(t, 23, c2.Hour())
	assert.EqualValues(t, 59, c2.Minute())
	...
	c1 = Create(2019, time.February, 10, 1, 1, 1, 1, getLocation("UTC"))
	c2 = c1.EndOfMonth()
	...
	c1 = Create(2008, time.February, 10, 1, 1, 1, 1, getLocation("UTC"))
	c2 = c1.EndOfMonth()
...
func TestCarbon_StartOfWeek(t *testing.T) {
	c1 := Create(2020, time.May, 28, 1, 1, 1, 1, getLocation("UTC"))
